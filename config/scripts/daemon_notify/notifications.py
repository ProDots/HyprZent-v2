#!/usr/bin/python
import re  # Asegúrate de tener esta importación al inicio del script
...
class NotificationDaemon(dbus.service.Object):
    ...
    def Notify(self, app_name, replaces_id, app_icon, summary, body, actions, hints, timeout):
        ...
        details = {
            ...
            "app": f"{app_name}",
            "summary": summary,
            "body": self.format_long_string(
                body,
                has_image=("image-data" in hints or app_icon.strip()),
                interval_with_image=35,
                interval_without_image=49
            ),
